...
class SelectOrCreateSource(SourcesWidget):
    def render(self, *args, **kwargs):
        widget_html = super().render(*args, **kwargs)
        template_html = render_to_string("interview/select_or_create_source.html")
        return format_html("{}\n{}", widget_html, template_html)
...
class SelectOrCreateOffer(ModelSelect2Widget):
    ...
    def render(self, *args, **kwargs):
        widget_html = super().render(*args, **kwargs)
        template_html = render_to_string("interview/select_or_create_offer.html")
        return format_html("{}\n{}", widget_html, template_html)
